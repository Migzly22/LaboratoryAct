...
function imgchanging123(paramname){
    ...
    let imgname1 = imgname.split("/")

    document.getElementById("imagechanger").src = "./IMG/"+ imgname1[imgname1.length-1]
}
        //ITEMS -- IMAGES (ITEMS MENU )
        $("#order1").click(function(e) {
            imgchanging123("#order1")
